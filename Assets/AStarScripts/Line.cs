...
public struct Line {
    ...
    public Line(Vector2 pointOnLine, Vector2 pointPerpendicularToLine) {
        ...
        if(dx == 0) { gradientPerpendicular = verticalLineGradient; } else { gradientPerpendicular = dy / dx; }
        if(gradientPerpendicular == 0) { gradient = verticalLineGradient; } else { gradient = -1 / gradientPerpendicular; }
